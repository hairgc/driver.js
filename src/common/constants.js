...
export const SHOULD_SHOW_STEP_DOTS = true;
export const SHOULD_HIGHLIGHT_ELEMENT_READONLY = false;
...
export const CLASS_DRIVER_HIGHLIGHTED_ELEMENT_READONLY = 'driver-highlighted-element-readonly';
